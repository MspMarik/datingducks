...
async function main() {
    ...
    const user6 = await users.create("Zane ICantSpellIt", 21, "drake", "zane@stevens.edu", "pic", "poomba", "goomba", "coldstone stole my wallet", "coldstone", "coldstone thief", "down to duck");
    ...
    const user16 = await users.create("R2-D2", 30, "goose", "r2-d2@stevens.edu", "pic", "artoo-detoo", "back2naboo", "AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAWWWW!!!", "Anakin, Luke, Padme, Leia, Han, Chewie", "not being update, old firmware, needing maintenance", "quacktonic");
}
