...
async function main() {
    ...
    const user3 = await users.create("Mark Spivak", 20, "Drake (Male)", "msp@stevens.edu", "pic", "mspmarik", "briisthebest", "ok scrabble player", "scrabble", "bad almond milk", "quacktonic", "Any");
    const user4 = await users.create("Jan Del Rosario", 21, "Drake (Male)", "jan@stevens.edu", "pic", "corgis", "dogsaresocute", "average scrabble player", "scrabble", "weird old couples", "requacktionship", "Hen (Female)");
    const user5 = await users.create("Faraz Pathan", 21, "Drake (Male)", "farpath20@stevens.edu", "pic", "farpath20", "farpath20", "terrible scrabble player", "scrabble, being a loser", "not getting ran over", "down to duck", "Hen (Female)");
    const user6 = await users.create("Zane ThummBorst", 21, "Drake (Male)", "zane@stevens.edu", "pic", "poomba", "goomba", "coldstone stole my wallet", "coldstone", "coldstone thief", "down to duck", "Hen (Female)");
    const user7 = await users.create("Luke Skywalker", 25, "Drake (Male)", "luke@stevens.edu", "pic", "lukesky", "bluemilk", "daddy issues", "blue milk", "my dad", "quacktonic", "Hen (Female)");
    ...
    const user10 = await users.create("Alina Starkov", 17, "Hen (Female)", "astarkov@stevens.edu", "pic", "sunsummoner", "themeadow", "Just your average mapmaker", "waffles", "the darkling", "requacktionship", "Drake (Male)");
    ...
    const user14 = await users.create("Jabba the Hutt", 213, "goose", "jabba@stevens.edu", "pic", "jabbajabba", "princessleia", "You know who I iz.", "Princess Leia", "Han Solo", "down to duck", "Hen (Female)");
